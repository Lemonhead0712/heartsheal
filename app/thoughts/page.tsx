    ...
    <div className="min-h-screen bg-page-gradient pb-24">
      <motion.div className="max-w-2xl mx-auto px-4 py-8" variants={container} initial="hidden" animate="show">
        ...
        <motion.div className="mb-8" variants={item}>
          ...
          <h1 className="font-serif text-3xl font-semibold text-foreground mt-4 mb-1">Thoughts & Reflection</h1>
          <p className="text-muted-foreground text-sm">A quiet space to write, explore, and understand yourself</p>
        </motion.div>

        {/* Tab switcher */}
        <motion.div className="flex gap-2 mb-8 p-1 rounded-2xl bg-muted/50 border border-border/40" variants={item}>
